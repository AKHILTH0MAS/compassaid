import 'package:compassaid/Admin/screens/Admin_Mech_Home.dart';
import 'package:compassaid/Admin/screens/Admin_User.dart';
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const AdminMechHome(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
              ...
              GestureDetector(
                onTap: () {
                   Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const AdminUserProfile(),
                    ),
                  );
                },
                child: Container(
